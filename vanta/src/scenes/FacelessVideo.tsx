...
export const FacelessVideo: React.FC<FacelessVideoProps> = ({
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#111122" }}>
      ...
      <style>
        {`
          @import url('https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,800;0,900;1,800&family=Righteous&display=swap');
        ...
        {currentTime < 2 && title && (
          <div
            ...
            style={{
              ...
              fontWeight: 900,
              fontFamily: "'Righteous', cursive", // Font unik
